...
process.env.NEXUS_NAME = process.env.NEXUS_NAME || "Veteran Crisis Response Command Center";
process.env.ENTITY_LABEL = process.env.ENTITY_LABEL || "Crisis Response Dispatch";
process.env.TABLE_NAME = process.env.TABLE_NAME || "crisis_response_dispatch_records";
'use strict';
